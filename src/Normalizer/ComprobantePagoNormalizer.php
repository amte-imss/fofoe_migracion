...
final class ComprobantePagoNormalizer implements NormalizerInterface
{
    ...
    public function normalize(mixed $comprobantePagoFile, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
    ...
    {
        return [ComprobantePagoFileInterface::class => true];
    }
}
